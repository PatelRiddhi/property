                                        ...
                                        <div class="agent-box">
                                            <div class="row">
                                                <div class="agent-box-picture col-sm-12">
                                                    <div class="agent-box-label agent-box-label-primary"><?php echo $row['current_status']; ?></div><!-- /.agent-row-picture-label -->
                                                ...
                                                <div class="agent-box-content col-sm-12">
                                                    <h3 class="agent-box-title"><a href="#"><?php echo $row['first_name']." ".$row['last_name']; ?></a></h3><!-- /.agent-row-title -->
                                                    <h4 class="agent-box-subtitle"><a href="#"><?php echo $row['post']; ?></a></h4><!-- /.agent-row-subtitle -->
